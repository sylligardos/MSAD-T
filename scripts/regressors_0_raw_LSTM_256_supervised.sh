#!/bin/bash
#SBATCH --job-name=regressors_0_raw_LSTM_256_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 0 --model_class raw --detector LSTM --window_size 256 --experiment supervised --saving_path experiments/regression_16_12_2024