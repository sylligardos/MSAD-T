#!/bin/bash
#SBATCH --job-name=regressors_0_raw_MP_512_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 0 --model_class raw --detector MP --window_size 512 --experiment supervised --saving_path experiments/regression_16_12_2024