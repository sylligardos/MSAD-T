#!/bin/bash
#SBATCH --job-name=regressors_0_raw_OCSVM_64_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 0 --model_class raw --detector OCSVM --window_size 64 --experiment supervised --saving_path experiments/regression_16_12_2024