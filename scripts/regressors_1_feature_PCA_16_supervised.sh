#!/bin/bash
#SBATCH --job-name=regressors_1_feature_PCA_16_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 1 --model_class feature --detector PCA --window_size 16 --experiment supervised --saving_path experiments/regression_16_12_2024