#!/bin/bash
#SBATCH --job-name=regressors_1_raw_AE_512_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 1 --model_class raw --detector AE --window_size 512 --experiment supervised --saving_path experiments/regression_16_12_2024