#!/bin/bash
#SBATCH --job-name=regressors_1_raw_IFOREST_64_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 1 --model_class raw --detector IFOREST --window_size 64 --experiment supervised --saving_path experiments/regression_16_12_2024