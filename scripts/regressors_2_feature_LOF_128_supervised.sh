#!/bin/bash
#SBATCH --job-name=regressors_2_feature_LOF_128_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 2 --model_class feature --detector LOF --window_size 128 --experiment supervised --saving_path experiments/regression_16_12_2024