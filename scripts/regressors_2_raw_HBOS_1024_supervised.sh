#!/bin/bash
#SBATCH --job-name=regressors_2_raw_HBOS_1024_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 2 --model_class raw --detector HBOS --window_size 1024 --experiment supervised --saving_path experiments/regression_16_12_2024