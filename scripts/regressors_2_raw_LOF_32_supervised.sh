#!/bin/bash
#SBATCH --job-name=regressors_2_raw_LOF_32_supervised               # Job name
...
# execution
python3 src/train_regressors.py --model_index 2 --model_class raw --detector LOF --window_size 32 --experiment supervised --saving_path experiments/regression_16_12_2024