...
def eval_regressors():
    ...
    # supervised_files = [file for file in supervised_files if ('Random' in file)]  # Test
    ...
    sns.boxplot(data=curr_piv_df, y='Selected VUS-PR', x='Model name', showmeans=True, whis=0.241289844, showfliers=False)
